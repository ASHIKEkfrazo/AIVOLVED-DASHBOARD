...
try {
  ...
  return (
    ...
    <img src="https://aivolved.in/wp-content/uploads/2022/11/ai-logo.png" style={{height:'80px'}} alt="" />
        ...
        <p className="">
        <ArrowLeftOutlined  style={{fontSize:'1.5rem',cursor:'pointer'}} onClick={()=>history.push("/login")}/>
        </p>
    ...
    <h2 className="">
        <button style={{padding:'0.8rem 3rem',background:'#ff4403',border:'none',borderRadius:'5px',color:'#fff',fontWeight:'600'}} onClick={confirmEmail}>Send Email</button>
    </h2>
      </Card>
      : 
      <Card  bordered={false} style={{padding:'2rem',borderRadius:'25px'}}>
      ...
      <h2 className="">
          <button style={{padding:'0.8rem 3rem',background:'#ff4403',border:'none',borderRadius:'5px',color:'#fff',fontWeight:'600'}}onClick={resetPost} >Submit</button>
      </h2>
        </Card>
    }
    </Col>
